defmodule Bludo.Polls.Poll do
  ...
  @type t :: %__MODULE__{
          ...
          poll_opts: [Bludo.Polls.PollOpt.t()],
          poll_votes: [Bludo.Polls.PollVote.t()] | nil,
  ...
  schema "polls" do
    ...
    has_many :poll_opts, Bludo.Polls.PollOpt,
      preload_order: [asc: :id],
      on_replace: :delete

    has_many :poll_votes, Bludo.Polls.PollVote, on_replace: :delete
