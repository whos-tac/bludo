defmodule Bludo.Stats do
  ...
  def get_distinct_poll_votes(poll_ids) do
    from(pv in Bludo.Polls.PollVote,
  ...
  def get_distinct_quiz_responses(quiz_ids) do
    from(pv in Bludo.Quizzes.QuizResponse,
  ...
  def get_distinct_form_submits(form_ids) do
    from(pv in Bludo.Forms.FormSubmit,
  ...
  def distinct_poster_count(event_id) do
    from(posts in Bludo.Posts.Post,
  ...
  def total_vote_count(presentation_file_id) do
    from(p in Bludo.Polls.Poll,
      join: pv in Bludo.Polls.PollVote,
      on: pv.poll_id == p.id,
