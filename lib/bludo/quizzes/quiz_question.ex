defmodule Bludo.Quizzes.QuizQuestion do
  use Ecto.Schema
  ...
  @type t :: %__MODULE__{
          ...
          quiz_question_opts: [Bludo.Quizzes.QuizQuestionOpt.t()] | nil,
  ...
  schema "quiz_questions" do
    ...
    has_many :quiz_question_opts, Bludo.Quizzes.QuizQuestionOpt,
  ...
  def changeset(quiz_question, attrs) do
    ...
    |> cast_assoc(:quiz_question_opts,
      required: true,
      with: &Bludo.Quizzes.QuizQuestionOpt.changeset/2,
