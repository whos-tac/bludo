defmodule Bludo.Quizzes.Quiz do
  use Ecto.Schema
  ...
  @type t :: %__MODULE__{
          ...
          quiz_responses: [Bludo.Quizzes.QuizResponse.t()] | nil,
          quiz_questions: [Bludo.Quizzes.QuizQuestion.t()] | nil,
          presentation_file: Bludo.Presentations.PresentationFile.t(),
  ...
  schema "quizzes" do
    ...
    has_many :quiz_questions, Bludo.Quizzes.QuizQuestion,
  ...
  def changeset(quiz, attrs) do
    ...
    |> cast_assoc(:quiz_questions,
      required: true,
      with: &Bludo.Quizzes.QuizQuestion.changeset/2,
