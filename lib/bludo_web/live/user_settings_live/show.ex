defmodule BludoWeb.UserSettingsLive.Show do
  ...
  def mount(_params, session, socket) do
    ...
    {:ok,
     ...
     |> assign(
       ...
       Application.get_env(:bludo, :allow_unlink_external_provider)
     )}
  end
  ...
  def handle_event(
    ...
    Bludo.Accounts.remove_oidc_user(socket.assigns.current_user, issuer)
  ...
  def handle_event("save", %{"action" => "update_preferences"} = params, socket) do
    ...
    available_locales = Gettext.known_locales(BludoWeb.Gettext)
