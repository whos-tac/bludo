defmodule BludoWeb.AdminLive.EventLive.FormComponent do
    ...
    <div>
      <.form for={@form} id="event-form" phx-target={@myself} phx-change="validate" phx-submit="save">
        <div class="grid grid-cols-6 gap-6">
          <.live_component
            module={BludoWeb.AdminLive.FormFieldComponent}
            id="event-name"
            form={@form}
            field={:name}
            type="text"
          ...
          <.live_component
            module={BludoWeb.AdminLive.SearchableSelectComponent}
            id="event-user-id"
            form={@form}
            field={:user_id}
