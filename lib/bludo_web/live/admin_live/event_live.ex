defmodule BludoWeb.AdminLive.EventLive do
  ...
  defp apply_action(socket, :edit, %{"id" => id}) do
    ...
    |> assign(:event, Bludo.Events.get_event!(id, [:user]))
  end
  ...
  def handle_event("delete", %{"id" => id}, socket) do
    event = Bludo.Events.get_event!(id)
    {:ok, _} = Bludo.Events.delete_event(event)
