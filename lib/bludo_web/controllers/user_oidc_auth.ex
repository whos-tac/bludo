defmodule BludoWeb.UserOidcAuth do
  @moduledoc """
  ...
  defp config do
    Application.get_env(:bludo, :oidc)
  end
  ...
  defp base_url do
    Application.get_env(:bludo, BludoWeb.Endpoint)[:base_url]
  end
  ...
  defp validate_user(id_token, access_token, refresh_token, claims) do
    ...
    case Bludo.Accounts.get_or_create_user_with_oidc(%{
           sub: claims["sub"],
           issuer: claims["iss"],
           name: claims["name"],
           email: claims["email"],
