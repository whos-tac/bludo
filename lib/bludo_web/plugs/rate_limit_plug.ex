defmodule BludoWeb.Plugs.RateLimitPlug do
  @moduledoc """
  Plug for rate limiting requests based on client IP address.

  ## Usage

      plug BludoWeb.Plugs.RateLimitPlug, max_requests: 10, interval_ms: 60_000, prefix: "login"
  """
  import Plug.Conn
  ...
  def call(conn, %{max_requests: max_requests, interval_ms: interval_ms, prefix: prefix}) do
    ...
    case Bludo.RateLimit.hit(key, interval_ms, max_requests) do
      {:allow, _count} ->
        conn
