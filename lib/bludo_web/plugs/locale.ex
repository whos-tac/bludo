defmodule BludoWeb.Plugs.Locale do
  @moduledoc """
  ...
  def call(conn, _opts) do
    known_locales = Gettext.known_locales(BludoWeb.Gettext)
    ...
    case accepted_languages do
      [locale | _] ->
        Gettext.put_locale(BludoWeb.Gettext, user_locale || locale)
